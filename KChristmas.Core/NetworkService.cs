...
namespace KChristmas.Core
{
    public class NetworkService
    {
        ...
        private readonly string GetGiftHintsUrl =
            "api/GetGiftHints?code=Z8RSw1TEMQtGP36KqEIax5bj/XRSvJQBAalBmteLYhWwrk9ldqSFhA==";
        private readonly string GetPinkieEventsUrl =
            "api/GetPinkieEvents?code=nUU8YEaQ6Dw4BgoqFAPFjM1NfTFd1hImXbd/EezinkbL9jbsq0ZBdQ==";
